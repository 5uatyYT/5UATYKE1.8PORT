	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'spooky':
				...
				playAnim('danceRight');
			case '5uatyacc':
				tex = Paths.getSparrowAtlas('5uatyacc', 'shared', true);
				frames = tex;

				animation.addByPrefix('idle', "5uatyacc IDLE", 24, false);
				animation.addByPrefix('singUP', "5uatyacc UP", 24, false);
				animation.addByPrefix('singDOWN', "5uatyacc DOWN", 24, false);
				animation.addByPrefix('singLEFT', '5uatyacc LEFT', 24, false);
				// Balls
				// LOL 5uaty IS very fucking dumb
				animation.addByPrefix('singRIGHT', '5uatyacc RIGHT', 24, false);
				animation.addByIndices('idleLoop', "5uatyacc IDLE", [11, 12], "", 12, true);
